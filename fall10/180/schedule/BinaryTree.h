...
class BinaryTree {
  ...
  protected:
    ...
    Node* _duplicate(const Node* other) {
      ...
      Node *newnode = Node(other._data, NULL, NULL, NULL);
     ...
     * Input parameters: 
    **/
    void _insertAsLeftChild(Iterator location, const ItemType& data) {
     ...
     * Input parameters: 
    **/
    void _insertAsRightChild(Iterator location, const ItemType& data) {
     ...
     */
    void _deleteAndMoveLeftChildUp(Iterator location) {
      _recursivelyDelete(location._current->_right);
     ...
     *  Input parameter location: an iterator referencing the node to be deleted.
     */
    void _deleteAndMoveRightChildUp(Iterator location) {
      _recursivelyDelete(location._current->_left);
     ...
     int _getAuxiliary(Iterator iter) {
      return iter._current->_aux;
    }

    void _setAuxiliary(Iterator iter, int v) {
      iter._current->_aux = v;
    }   
    
    void _createRoot(const ItemType& value) {
